...
/***********************************************************************************************************************
*函数原型：bool AC_WPNav::zigzag_advance_wp_target_along_track(float dt)
*函数功能：AB点函数运行
*修改日期：2018-9-10
*修改作者：cihang_uav
...
bool AC_WPNav::zigzag_advance_wp_target_along_track(float dt)
{
    ...
    //////////////////////////////////////修改代码//////////////////////////////
    //    _pos_control.set_pos_target(final_target);
        _pos_control.set_pos_target_xy(final_target);
    //////////////////////////////////修改代码///////////////////////////////////
...
bool AC_WPNav::ushape_advance_wp_target_along_track(float dt)
{
...
bool AC_WPNav::update_zigzag_wpnav(void)
{
    ...
    // advance the target if necessary
    if (!zigzag_advance_wp_target_along_track(dt))
    {
        // To-Do: handle inability to advance along track (probably because of missing terrain data)
        ret = false;
    }
...
bool AC_WPNav::update_ushape_wpnav(void)
{
    ...
    {
        // advance the target if necessary
        if (!ushape_advance_wp_target_along_track(dt))
        {
            // To-Do: handle inability to advance along track (probably because of missing terrain data)
            ret = false;
        }
